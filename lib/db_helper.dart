...
class DBHelper{
  ...
  Future<Database> openDB() async {
    ...
    return await openDatabase(dbPath, version: 1, onCreate: (db, version){
      ...
      db.execute("create table $TABLE_TODO ( $COLUMN_TODO_ID integer primary key autoincrement, $COLUMN_TODO_TITLE text, $COLUMN_TODO_REMARK text, $COLUMN_TODO_IS_COMPLETED integer, $COLUMN_TODO_CREATED_AT text)");
